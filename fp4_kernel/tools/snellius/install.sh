...
conda create -n -y fp4 python==3.11
conda activate fp4
conda install -y nvidia/label/cuda-12.8.1::cuda-toolkit

unset
pip install -y --pre torch --index-url https://download.pytorch.org/whl/nightly/cu128
pip install -y numpy